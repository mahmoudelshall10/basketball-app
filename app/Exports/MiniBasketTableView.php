...
class MiniBasketTableView extends  \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements FromView,WithEvents,WithCustomValueBinder
{
    use Exportable;
    ...
    */
    public function view(): View
    {
        ...
        return view('panel.search.minibasket.miniBasketTable',
