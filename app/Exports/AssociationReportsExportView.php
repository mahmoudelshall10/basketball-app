...
class AssociationReportsExportView  extends \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements FromView,WithEvents,WithCustomValueBinder
{
    /**
    ...
    */
    public function view(): View
    {
        ...
        return view('panel.report.association_report.associationTable',compact(
            ['arrayAssociationObj',
            'total',
