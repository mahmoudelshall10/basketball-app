...
class CairoAreaTableView extends  \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements FromView,WithEvents,WithCustomValueBinder
{
    private $id;
    ...
    */
    public function view(): View
    {
        ...
        return view('panel.search.cairoarea.cairoAreaTable',compact(
            ['arrayCairoObj',
            'total',
