                ...
                <div class="col-lg-12">
                      <section class="card">
                         <div class="card-body">
                              ...
                              <form class="form-horizontal tasi-form" method="POST" action="{{route('team.update',$team->team_id)}}" enctype="multipart/form-data" id="commentForm">
                                 @csrf()
                                 @method('PUT')
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Team Name</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="required form-control @if ($errors->has('team_name')) is-valid @endif"  name="team_name" value="{{$team->team_name}}" >
                                    ...
                                    <label class="col-sm-2 control-label">City Name</label>  
                                        <div class="col-sm-10">
                                            ...
                                            @foreach ($arrCities as $city)
                                                <option {{$city->city_id == $team->city_id ? 'selected':''}} value="{{$city->city_id}}">{{$city->city_name_en}}</option>
                                            @endforeach
                                            </select>
                                          ...
                                          <div class="col-lg-10">
                                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                                      <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                          ...
                                                          @else
                                                              <img src="{{asset($team->team_logo)}}" alt="" />
                                                          @endif
                                                      </div>
