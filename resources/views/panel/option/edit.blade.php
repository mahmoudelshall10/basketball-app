                ...
                <div class="col-lg-12">
                      <section class="card">
                         <div class="card-body">
                              ...
                              <form class="form-horizontal tasi-form" method="POST" action="{{route('question_option.update',$option->option_id)}}" enctype="multipart/form-data" id="commentForm">
                                 @csrf()
                                 @method('PUT')
                                      ...
                                      <div class="col-sm-10">
                                          <select class="required  form-control @if ($errors->has('question_id')) is-valid @endif" name="question_id" >
                                             <option  value="" disabled="disabled" selected="">Select Question</option>
                                                        ...
                                                        <option value="{{$question->question_id}}" @if( $option->question_id == $question->question_id){{"selected"}}@endif >{{$question->question_content}}</option>
                                                        @endforeach
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="required form-control @if ($errors->has('option_text')) is-valid @endif"  name="option_text" value="{{$option->option_text}}" >
                                     ...
                                     <div class="col-lg-12">
                                          ...
                                          <!--  <div class="custom-control custom-checkbox mb-3">
                                            ...
                                            <div class="custom-control custom-radio mb-3">
                                              <input type="radio" id="customRadio" name="option_correct" class="custom-control-input required @if ($errors->has('option_correct')) is-valid @endif" value="1" @if($option->option_correct == 1) {{"checked"}} @endif>
                                              <label class="custom-control-label" for="customRadio">Correct</label>
                                          </div>
                                          <div class="custom-control custom-radio mb-3">
                                             <input type="radio" id="customRadio1" name="option_correct" class="custom-control-input required @if ($errors->has('option_correct')) is-valid @endif" value="0" @if($option->option_correct == 0) {{"checked"}} @endif>
                                               <label class="custom-control-label" for="customRadio1">Incorrect</label>
                                          </div>
