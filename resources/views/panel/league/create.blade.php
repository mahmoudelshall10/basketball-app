                    ...
                    @endif
                      <section class="card">
                         <div class="card-body">
                              ...
                              <form class="form-horizontal tasi-form" method="POST" action="{{route('league.store')}}" enctype="multipart/form-data" id="commentForm">
                                 @csrf()
                                 @method('POST')
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">League Name</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="required form-control @if ($errors->has('league_name')) is-valid @endif"  name="league_name" value="{{old('league_name')}}" >
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <select class="required  form-control @if ($errors->has('league_type')) is-valid @endif" name="league_type" id="league_type" required>
                                          <option value="">Choose League Type</option>
