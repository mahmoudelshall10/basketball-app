...
@section('content')
 <!-- page start-->
  <div class="row">
                  <div class="col-lg-12">
                      ...
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">All Association Allowances </li>
              ...
              <div class="card-body">
                {{-- <a class="btn btn-success" href="{{route('page-print')}}">Save as pdf</a> --}}
              <div class="adv-table">
              ...
              <tbody>
         	    @foreach($associationAllowancesValues as $allowanceValue)
              <tr>
