                ...
                <div class="col-lg-12">
                      <section class="card">
                         <div class="card-body">
                              ...
                              <form class="form-horizontal tasi-form" method="POST" action="{{route('hall.store')}}" enctype="multipart/form-data" id="commentForm">
                                 @csrf()
                                 @method('POST')
                                 ...
                                 <div class="form-group">
                                         ...
                                         <select class="required form-control @if ($errors->has('hall_place')) is-valid @endif"  name="hall_place">
                                            ...
                                            @foreach ($cities as $city)
                                                <option value="{{$city->city_id}}"
                                                        @if ($city->city_id)
                                                            @if (old('hall_place') == $city->city_id ) {{"selected"}} @endif 
                                                        @endif 
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="required form-control @if ($errors->has('hall_name')) is-valid @endif"  name="hall_name" value="{{old('hall_name')}}" >
