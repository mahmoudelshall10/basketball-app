                ...
                <div class="col-lg-12">
                      <section class="card">
                         <div class="card-body">
                              ...
                              <form class="form-horizontal tasi-form" method="POST" action="{{route('news.store')}}" enctype="multipart/form-data" id="commentForm">
                                 @csrf()
                                 @method('POST')
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">News Title</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="required form-control @if ($errors->has('new_title')) is-valid @endif"  name="new_title" value="{{old('new_title')}}" >
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <textarea class="  form-control   @if ($errors->has('new_description')) is-valid @endif" name="new_description" rows="2">{{old('new_description')}}</textarea>
